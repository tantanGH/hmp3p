...
PhantomX ハイメモリ ライトバックモード専用のMP3音楽プレーヤです。
...
* X68000実機
* PhantomX version 1.3x / 1.4x
* Raspberry Pi 4B (なるべく後期型)
* MPU ライトバックモード (ライトスルーモードでは処理が追いつきません)
* ハイメモリ256MB以上
* Mercury-UNIT V2.0/V3.0/V3.1/V3.5/V4.0 または PilederX または KeplerX
