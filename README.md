...
内蔵ADPCMの場合は44.1kHzからのダウンサンプリングがギリギリ間に合うかどうかです。間に合わない場合は`-b8`など、バッファサイズを大きくとるか、`-q1`で22.05kHzからのダウンサンプリングにしてみてください。
...
* 0.6.0 (2026/03/08) ... 68000汎用バイナリ/68030以上専用バイナリ/68060専用バイナリの3つを同梱
